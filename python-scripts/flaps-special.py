...
renderView1.CameraPosition = [2600.5, 457.0, 140.0]
renderView1.CameraFocalPoint = [-13882.5, 218.5, -1864.0]
renderView1.CameraViewUp = [-0.0, 0.0, 1.0]
renderView1.CameraViewAngle = 5
...
SaveScreenshot(path+"/medium-flaps.png")
