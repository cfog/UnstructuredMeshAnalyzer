...
renderView1.CameraPosition = [1683.0, 1006.0, 627.0]
renderView1.CameraFocalPoint = [2800.0, 1900.0, -4459.0]
renderView1.CameraViewUp = [-0.8085, 0.5885, 0.0]
renderView1.CameraParallelScale = 1368.98566176338
...
SaveScreenshot(path+"/medium-wing-tip.png")
