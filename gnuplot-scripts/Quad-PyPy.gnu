...
set terminal postscript eps noenhanced defaultplex \
   ...
   dashed dashlength 5.0 linewidth 2.0 butt noclip \
   nobackground \
   palfuncparam 2000,0.003 \
   "Helvetica" 22  fontscale 1.0 size 4, 3
set output 'Quad-PyPy.eps'
unset clip points
set clip one
unset clip two
...
set title "Pyramid-Pyramid (Quad Faces)" 
...
set xlabel "Size Ratio" 
set xlabel  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set x2label "" 
set x2label  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set xrange [ * : * ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "Fraction of Faces" 
...
GNUTERM = "wxt"
plot 'medium-size.dat' using 1:8
#    EOF
